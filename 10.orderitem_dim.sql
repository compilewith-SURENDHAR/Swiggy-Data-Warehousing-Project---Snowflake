...
from (
    ...
    from @stage_sch.csv_stg/initial/oder-item/order-Item-initial.csv t
)
file_format = (format_name = 'stage_sch.csv_format')
on_error = abort_statement;

--'@"SWIGGY"."STAGE_SCH"."CSV_STG"/initial/oder-item/order-Item-initial.csv'

select count(*) from stage_sch.orderitem;
